...
@section('content')
    ...
    <div class="hero-section hero-background">
        <h1 class="page-title">Item Variants</h1>
    </div>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">Item Variants</span></li>
            </ul>
        </nav>
    </div>
...
@endforeach
                        ...
                        @else
<p style="font-size: 35px;color:red;text-align:center;margin-top: 47%;">No Item Variant images Found</p>
                    ...
                    <div class="action-form">
                        ...
                        <div class="buttons">
                            <a href="{{url('shopping')}}" class="btn add-to-cart-btn">add to cart</a>
                            <p class="pull-row">
                        ...
                        <div class="acepted-payment-methods">
                            <ul class="payment-methods">
                                <li><img src="{{url('assets/images/card1.jpg')}}" alt="" width="51" height="36"></li>
                                <li><img src="{{url('assets/images/card2.jpg')}}" alt="" width="51" height="36"></li>
                                <li><img src="{{url('assets/images/card3.jpg')}}" alt="" width="51" height="36"></li>
                                <li><img src="{{url('assets/images/card4.jpg')}}" alt="" width="51" height="36"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="{{url('assets/images/products/p-15.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Fresh Fruit</b>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="{{url('assets/images/products/p-21.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Fresh Fruit</b>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="{{url('assets/images/products/p-18.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Fresh Fruit</b>
